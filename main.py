...
###########################    Step 2 : Train Model   ##############################
    ...
    hog_train = extract_feature(dir_save_feature, "X_train", X_train, cell_size, bin_size)
    train_feature = hog_train.HoG_output_vector()
    print("\n >>>>>> Extract Train Feature !!!!!!  Suceess  !!!!!! \n") 
    hog_test = extract_feature(dir_save_feature, "X_test", X_test, cell_size, bin_size)
    test_feature = hog_test.HoG_output_vector()
    print(" >>>>>> Extract Test Feature !!!!!!  Suceess  !!!!!! \n") 
